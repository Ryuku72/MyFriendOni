            ...
            />
               <ul className="absolute hidden text-gray-700 pt-1">
                ...
                <SearchBtn title="Sort By" style={{backgroundColor:"#90cdf4"}}>
                    ...
                    <li>
                <a href="/#" className="rounded-t w-full bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" name="rowTab" onClick="" style="">
               Row</a>
               </li>
               <li>
                <a href="/#" className="bg-gray-200 w-full hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" onClick="" style="" name="jpnTab" >
                Japanese</a></li>
                <li>
                <a href="/#" className="bg-gray-200 w-full hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" onClick="" style="" name="engTab">
                English</a></li>
                    </ul>
                </SearchBtn >
                ...
                <ul className="absolute pt-2 z-50">
                    <li>
                <a href="/" className="rounded-t w-full bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" onClick="" name="Ascend" style="">
                Ascend</a></li>
                        <li>Descend</li>
                    </ul>
                </SearchBtn>
