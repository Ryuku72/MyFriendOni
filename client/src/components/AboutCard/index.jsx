...
function AboutCard(props){
    return (
        <div className="aboutText w-full h-full block absolute top-0 overflow-hidden" style={props.windowStyle}>
            <div className="flex flex-wrap flex-row overflow-hidden items-center justify-center p-2">
                <div className="h-full w-1/3 flex justify-center items-center border-gray-800 border-r-2 border-b-2" style={{width:"20%", height:"20vh" }}>
                <img src={TailPic} alt="tailwind" style={{width:"50%"}}/> 
                </div>
                <div className="h-full flex justify-center items-center border-r-2 border-b-2 border-gray-800" style={{width:"20%", height:"20vh" }}>
                <img src={NodePic} alt="nodejs" style={{width:"80%"}}/>
                </div>
                <div className="h-full flex items-center justify-center border-r-2 border-b-2 border-gray-800" style={{width:"20%", height:"20vh" }}>
                <img src={ExpressPic} alt="express"style={{width:"70%"}}/>
                </div>
                <div className="h-full w-1/4 flex justify-center items-center border-r-2 border-b-2 border-gray-800" style={{width:"20%", height:"20vh" }}>
                <img src={MongoPic} alt="mongo" style={{width:"80%"}}/> 
                </div>
                <div className="h-full w-1/3 flex justify-center items-center border-b-2 border-gray-800" style={{width:"20%", height:"20vh" }}>
                <img src={htmlPic} alt="htmllogo" style={{width:"50%"}}/> 
                </div>
                <div className="h-full w-1/3 flex justify-center items-center border-r-2 border-b-2 border-gray-800" style={{width:"20%", height:"20vh" }}>
                ...
                <div className="h-full w-1/3 flex justify-center items-center border-r-2 border-gray-800" style={{width:"20%", height:"20vh" }}>
                <img src={coffeegif} alt="coffeePic" style={{width:"30%"}}/> 
                </div>
                <div className="h-full w-1/3 flex justify-center items-center border-r-2 border-gray-800" style={{width:"20%", height:"20vh" }}>
                <p className="text-center ftk">Foreign Toolkit</p>
                </div>
                <div className="h-full flex justify-center items-center border-r-2 border-gray-800" style={{width:"20%", height:"20vh" }}>
                <img src={ReactPic} alt="react"style={{width:"30%", height: "80%"}}/>
                </div>
                <div className="h-full w-1/3 flex justify-center items-center border-r-2 border-gray-800" style={{width:"20%", height:"20vh" }}>
                <img src={googlePic} alt="googleFont" style={{width:"90%"}}/> 
                </div>
                <div className="h-full w-1/3 flex justify-center items-center border-gray-800" style={{width:"20%", height:"20vh" }}>
