...
function AboutCard(props){
    return (
        <div className="aboutText w-full h-full block absolute top-0 overflow-hidden" style={props.windowStyle}>
            ...
            <div className="h-full w-1/3 flex justify-center items-center" style={{width:"20%", height:"20vh" }}>
            ...
            <div className="h-full w-1/3 flex justify-center items-center " style={{width:"20%", height:"20vh" }}>
                ...
                <div className="h-full flex justify-center items-center " style={{width:"20%", height:"20vh" }}>
                <img src={NodePic} alt="nodejs" style={{width:"80%"}}/>
                </div>
                <div className="h-full flex items-center justify-center " style={{width:"20%", height:"20vh" }}>
                <img src={ExpressPic} alt="express"style={{width:"70%"}}/>
                </div>
                <div className="h-full w-1/4 flex justify-center items-center " style={{width:"20%", height:"20vh" }}>
                ...
                <div className="h-full w-1/3 flex justify-center items-center" style={{width:"20%", height:"20vh" }}>
                <img src={TailPic} alt="tailwind" style={{width:"45%"}}/> 
                </div>
                <div className="h-full w-1/3 flex justify-center items-center" style={{width:"20%", height:"20vh" }}>
                ...
                <div className="h-full w-1/3 flex justify-center items-center" style={{width:"20%", height:"20vh" }}>
                <img src={flatPic} alt="flatIconPic" style={{width:"100%"}}/> 
                </div>
