...
return( 
    <li>
<div className={`py-3 menu-item flex justify-between items-center hover:bg-orange-400 rounded-lg font-mono ${props.align}`} onClick={props.click}>
<div className={`w-1/3 ${props.IconAlign}`}>
