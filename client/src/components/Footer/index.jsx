...
function Footer(props) {
  ...
  return (
    <footer className={`w-full relative flex justify-between my-auto mt-auto mb-0 items-center  p-6 footer ${bgColor}`}>
      ...
      <>
      <p className="footer mr-4 text-blue-700 text-right flex items-center"><span className="mr-4 text-pink-600 capitalize ">{props.user}</span>{'//'} Foreign Toolkit 2020 </p>
      </>
    </footer>
  );
}
