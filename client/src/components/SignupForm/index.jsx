...
<p className="mb-8 text-gray-700">Please fill out the information below</p>
  ...
  <button className="flex-shrink-0 bg-pink-500 hover:bg-pink-700 border-pink-500 hover:border-pink-700 text-sm border-4 text-white py-1 px-4 rounded font-mono" type="submit" onClick={props.postSignUp}>
      Sign Up
    </button>
